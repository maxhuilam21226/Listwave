-- LaunchKit schema. Run this in the Supabase SQL editor (or via `supabase db push`).
-- Outlets are NOT stored here — they live as version-controlled JSON in src/lib/outlets/data.
...
-- outlet_id is a string key that matches an Outlet JSON `id` in the repo.
-- ---------------------------------------------------------------------------
